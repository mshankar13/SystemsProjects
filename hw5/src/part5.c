...
struct file_node *file_node_head5 = NULL;
struct threads *threads_head5 = NULL;

volatile int threads_count5 = 0;
...
int part5(size_t nthreads){
    ...
    while (thread_num < nthreads) {
        ...
        while (Readdir_r(dir_ptr, entry, &result) == 0 && (result != NULL)) { /*Loop through each file*/
            if (strcmp(result->d_name, ".") != 0 && strcmp(result->d_name, "..") != 0) { /*Valid file?*/
                ...
                if (num_files_read == 0) {
                    ...
                    if (threads_head5 == NULL) {
                        threads_head5 = thread_node;
                        threads_head5->next = NULL;
                        threads_head5->prev = NULL;
                    } else {   
                        threads_head5->prev = thread_node;
                        thread_node->next = threads_head5;
                        threads_head5 = thread_node;
                        threads_head5->prev = NULL;
                    }
                }
                ...
                node->prev = NULL;
                node->next = NULL;
                if (file_node_head5 == NULL) { /*Add the file to the list for reduce*/
                    file_node_head5 = node;
                    file_node_head5->next = NULL;
                    file_node_head5->prev = NULL;
                } else {
                    file_node_head5->prev = node;
                    node->next = file_node_head5;
                    file_node_head5 = node;
                    file_node_head5->prev = NULL;
                }
        ...
        pthread_setname_np(thread, thread_name (threads_count5, "Map"));
        threads_count5++;
    ...
    struct threads *current_thread = threads_head5;
    ...
    free(entry);
    struct file_node *current_node = file_node_head5;
    /*Free filenames*/
